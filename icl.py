...
from dataset import   GPTClassificationCollator, DemonClassificationDataset
...
def main(model_name, dataset, bs, epochs, output_dir, lr, num_shot, local_rank=-1, deepspeed=None, evaluate_only=None, resume=None, seed=0, pretrain=None):
    ...
    train_dataset = DemonClassificationDataset(params, 'train', tokenizer)
    eval_dataset = DemonClassificationDataset(params, 'test', tokenizer)
